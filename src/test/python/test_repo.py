...
from src.main.python.repository.app_repo import AppRepository


class TestAppRepository(unittest.TestCase):
    @patch('src.main.python.model.application.ApplicationDecoder')
    @patch('src.main.python.model.application.ApplicationEncoder')
    ...
    def test_load_app(self):
        with patch('src.main.python.repository.app_repo.sqlite3') as sqlite3:
            # given
